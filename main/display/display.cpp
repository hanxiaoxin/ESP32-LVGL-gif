...
Display::Display() {
  ...
  // bg timer
  esp_timer_create_args_t bg_timer_args = {
      .callback =
          [](void *arg) {
  ...
  ESP_ERROR_CHECK(esp_timer_start_periodic(bg_timer_, 100000));
...
void Display::ShowNotification(const std::string &notification,
                               int duration_ms) {
