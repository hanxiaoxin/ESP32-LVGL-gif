...
public:
  ...
  virtual void ShowNotification(const std::string &notification,
                                int duration_ms = 3000);
  ...
  virtual void setBackGroundfromSDCARD();
...
protected:
  ...
  static const size_t MAX_BG_IMG_COUNT = 50; // 定义最大缓存
